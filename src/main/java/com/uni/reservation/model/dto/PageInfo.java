...
public class PageInfo {
	...
	private int resLimit;			// 한 페이지에 보여질 res 최대 갯수
	
	public PageInfo() {
		
	}

	public PageInfo(int listCount, int currentPage, int startPage, int endPage, int maxPage, int pageLimit, int resLimit) {
		super();
	...
	public String toString() {
		return "PageInfo [listCount=" + listCount + ", currentPage=" + currentPage + ", startPage=" + startPage
				+ ", endPage=" + endPage + ", maxPage=" + maxPage + ", pageLimit=" + pageLimit + ", resLimit="
				+ resLimit + "]";
	}
