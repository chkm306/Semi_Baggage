...
/**
 * Servlet implementation class StorageSearchServlet
 */
@WebServlet("/searchStorage.do")
public class StorageSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StorageSearchServlet() {
        super();
